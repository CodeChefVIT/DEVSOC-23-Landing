...
export default function Landing() {
  ...
  return (
    <>
      ...
      <section className="prize-features" id="prizes">
        <Prizes />
      </section>
      ...
      <section className="spon-features" id="sponsors">
        <div>
          ...
          <a
            href="https://www.amantyatech.com/"
            target="_blank"
            rel="noreferrer"
          >
            <img className="titlelogo" src={titlecards} alt=""></img>
          </a>
          ...
          <a
            href="https://www.brilliantprinters.com/"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://www.top-one-percent.com/"
            target="_blank"
            rel="noreferrer"
          >
